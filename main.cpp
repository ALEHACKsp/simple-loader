...
static void printf_sucess_lic() {
	...
	std::cout << "  " << color(blue) << "RU:" << color(grey) << "" << strenc(" вы имеете лицензию, ваши дни ")
		<< color(blue) << auth::get_days_user() << color(grey) << strenc(" дл€ использовани€ продукта.") << std::endl;
	...
	std::cout << "  " << color(blue) << "RU:" << color(grey) << "" << strenc(" напишите ")
		<< color(blue) << "/inject" << color(grey) << strenc(" дл€ внедрени€ продукта.") << std::endl;
	...
	if (inj == L'/inject') {
		...
		std::cout << "  " << color(red) << "RU:" << color(grey) << strenc(" неизвестна€ команда") << std::endl;
		Sleep(1200);
	}
...
static void check_options() {
	if (is_running_admin_mode() == TRUE) {
		...
		std::cout << "  " << color(red) << "RU:" << color(grey) << "" << strenc(" запустите от имени ") << color(red)
			<< "админа" << std::endl;
...
static void printf_error_lic() {
	...
	std::cout << "  " << color(red) << "RU:" << color(grey) << "" << strenc(" вы не имеете ") << color(red) << "лицензии" << color(grey)
		<< strenc(" дл€ использовани€ продукта.") << std::endl;
	Sleep(2555);
